...
},{}],"src/app/model/core/model.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Sort = exports.SortEvent = void 0;
...
var Sort = /*#__PURE__*/function () {
  ...
  _createClass(Sort, [{
    ...
    key: "remakeArray",
    value: function remakeArray(newSize) {
      this.array = this.initArray(newSize);
    }
  }, {
    key: "bubbleSort",
    value: function () {
      var _bubbleSort = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var i, j, _ref;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                if (this.array[j] > this.array[j + 1]) {
                  _ref = [this.array[j + 1], this.array[j]];
                  this.array[j] = _ref[0];
...
exports.Sort = Sort;
},{}],"src/app/view/timer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Timer = exports.TimerEvents = void 0;
  ...
  _createClass(Timer, [{
    ...
    value: function start() {
      ...
      this.interval = setInterval(function () {
        return _this.dispatch(TimerEvents.tick, {
          msFromStart: Date.now() - _this.startTime,
          timeFromStart: _this.startTime
        });
      }, 100);
    }
  }, {
...
exports.Timer = Timer;
},{}],"src/app/view/view.js":[function(require,module,exports) {
"use strict";
...
var Visualizer = /*#__PURE__*/function () {
  function Visualizer() {
    ...
    this.timer.addEventListener(_timer.TimerEvents.tick, function (params) {
      _this.timerValue.innerText = "".concat(Math.round(params.msFromStart / 1000), "s ").concat(params.msFromStart % 1000, "ms");
    });
  }
  ...
  _createClass(Visualizer, [{
    ...
    key: "redrawVisual",
    value: function redrawVisual(array, highlight) {
      this.visualizer.innerHTML = '';

      for (var i = 0; i < array.length; i++) {
        var height = array[i];
        var column = createColumn(this.visualizer.clientWidth / array.length, height);
        if (this.visualizer.clientWidth / array.length > 40) column.innerText = height;
        if (i === highlight) column.style.backgroundColor = "yellow";
...
},{"./timer":"src/app/view/timer.js"}],"src/app/index.js":[function(require,module,exports) {
"use strict";

require("regenerator-runtime/runtime");

var _model = require("./model/core/model");

var _view = require("./view/view");

//TODO Add timer
//TODO Add shift counter
var vis = new _view.Visualizer();
var currentSize = vis.slider.value;
var sort = new _model.Sort(currentSize);
vis.createVisual(sort.getArray());
sort.addEventListener(_model.SortEvent.ItemsSorted, function (params) {
  vis.createVisual(sort.getArray(), params.indexTwo);
  vis.updateCounter();
});
sort.addEventListener(_model.SortEvent.SortingFinished, function (params) {
  vis.createVisual(sort.getArray());
  vis.timer.stop();
});
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./model/core/model":"src/app/model/core/model.js","./view/view":"src/app/view/view.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
