...
var array = initArray(10);
redrawVisual(array);
newArrayButton.addEventListener('click', function (e) {
  if (e.button === 0) {
    array = initArray(10);
    redrawVisual(array);
  }
...
function redrawVisual(array) {
  visualizer.childNodes.forEach(function (x) {
    x.remove();
  });
  array.forEach(function (height) {
    return visualizer.appendChild(createColumn(height));
  });
}
