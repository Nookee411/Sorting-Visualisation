      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (!(this.state == _sortingState.sortingState.sorting)) {
              _context.next = 12;
              break;
            }

            _context.next = 9;
            return compareAndDispatch(j, j + 1);
...
},{"./constants/sortingState":"app/model/core/constants/sortingState.js"}],"app/model/core/SortManager.js":[function(require,module,exports) {
"use strict";
...
function SortManager(n, sortName) {
  ...
  var selectionSort = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      var i, res, findMaxValue, _findMaxValue;

      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _findMaxValue = function _findMaxValue3() {
                _findMaxValue = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(startIndex) {
                  var maxIndex, _i;
                    ...
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        ...
                        case 2:
                          ...
                          _context2.next = 6;
                          return compareAndDispatch(_i, maxIndex);
                ...
                return _findMaxValue.apply(this, arguments);
              };

              findMaxValue = function _findMaxValue2(_x) {
                return _findMaxValue.apply(this, arguments);
              };
            ...
            case 3:
              if (!(i < array.length && sortState == _sortingState.sortingState.sorting)) {
                _context3.next = 12;
                break;
              }
  ...
  var insertionSort = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              _context4.next = 7;
              return compareAndDispatch(indexOfEle, indexOfEle - 1);
            ...
            case 8:
              ...
              _context4.next = 11;
              return swapAndDispatch(indexOfEle - 1, indexOfEle);
    ...
    return function insertionSort() {
      return _ref3.apply(this, arguments);
    };
  }();

  var mergeSort = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(splittedArray, startIndex) {
    ...
    return function mergeSort(_x2, _x3) {
      return _ref4.apply(this, arguments);
    };
  }();

  var mergeArrays = /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(leftArr, rightArr, startIndex) {
      var _ret;
                      ...
                      case 8:
                        ...
                        _loop = function _loop(_i2) {
                          sleepDuration(config.SwapTime).then(function (resolve) {
                            array[_i2 + startIndex] = mergedArray[_i2];
                            dispatch(_sortEvent.sortEvent.ItemSwapped, {
                              indexOne: _i2 + startIndex
                            });
                          });
                        };

                        for (_i2 = 0; _i2 < mergedArray.length && sortState == _sortingState.sortingState.sorting; _i2++) {
                          _loop(_i2);
                        }
    ...
    return function mergeArrays(_x4, _x5, _x6) {
      return _ref5.apply(this, arguments);
    };
  }();

  var partition = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(left, right) {
      var pivot, i, j;
    ...
    return function partition(_x7, _x8) {
      return _ref6.apply(this, arguments);
    };
  }();

  var quickSort = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(left, right) {
      var index;
    ...
    return function quickSort(_x9, _x10) {
  ...
  var pushToMaxArray = /*#__PURE__*/function () {
    var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(array, i) {
      var leftChildIndex, rightChildInex, maxChildIndex, _ref12;
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              _ref12 = [array[maxChildIndex], array[i]];
              array[i] = _ref12[0];
              array[maxChildIndex] = _ref12[1];
              dispatch(_sortEvent.sortEvent.ItemSwapped, {
    ...
    return function pushToMaxArray(_x11, _x12) {
  ...
  var sleepDuration = /*#__PURE__*/function () {
    var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(durationTime) {
    ...
    return function sleepDuration(_x13) {
      return _ref13.apply(this, arguments);
    };
  }();

  var swapAndDispatch = /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(firstIndex, secondIndex) {
      var _ref15;
      ...
      return regeneratorRuntime.wrap(function _callee15$(_context15) {
        while (1) {
          switch (_context15.prev = _context15.next) {
            ...
            case 3:
              _ref15 = [array[secondIndex], array[firstIndex]];
              array[firstIndex] = _ref15[0];
              array[secondIndex] = _ref15[1];
              dispatch(_sortEvent.sortEvent.ItemSwapped, {
                indexOne: firstIndex,
    ...
    return function swapAndDispatch(_x14, _x15) {
      return _ref14.apply(this, arguments);
    };
  }();

  var compareAndDispatch = /*#__PURE__*/function () {
    var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(firstIndex, secondIndex) {
        ...
        while (1) {
          switch (_context16.prev = _context16.next) {
            ...
            case 3:
              ...
              return _context16.abrupt("return", array[firstIndex] > array[secondIndex]);
    ...
    return function compareAndDispatch(_x16, _x17) {
      return _ref16.apply(this, arguments);
    };
  }();
}
},{"moment":"../node_modules/moment/moment.js","./constants/sortEvent":"app/model/core/constants/sortEvent.js","./constants/sortingState":"app/model/core/constants/sortingState.js","./Sorter":"app/model/core/Sorter.js"}],"app/view/timer.js":[function(require,module,exports) {
"use strict";
